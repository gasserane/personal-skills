...
- **AI-use disclosure.** The disclosure is mandatory on every artifact, not only articles and posts. Articles and posts carry the P.S. disclosure line; kits carry the disclosure paragraph in exemplar wording before the brand footer, docx and workbook alike; document-post captions carry the compressed P.S. The framing is always Ane's drafts-verifies-decides: written with help from the system it describes. This is the series' credibility signature, not boilerplate, and it is enforced by the Stage 4 checklist and Stage 5 pre-publish check, never by copying an exemplar generator.
