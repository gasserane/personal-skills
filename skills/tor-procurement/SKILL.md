...
description: 'Build, review, grade and defend procurement Terms of Reference (ToRs) for consultancy and service contracts: build a branded docx, grade 1-10 with strong and weak points, respond to a named reviewer''s objections, or finalise revisions with edit-preservation. Use when Ane drafts, hardens, or defends a ToR, or prepares to contract a consultant or service provider. Distinct from /proposal (funding proposals TO donors), implementation-pack (post-award tracking), procurement-offer-review (incoming supplier offers), and accreditation-desk-review (MA compliance). When Ane is the reviewer commenting on someone else''s draft, that is the opposite direction and not this skill.'
model: opus
---
