...
- **Topics** tab: the registry of what every topic tag means, one row per (tag, counterpart). The updater maintains Topic, Counterpart, Name, First seen, Last discussed and Times discussed. Ane owns the judgement columns, all with drop-downs where sensible: My role (Lead / Co-lead / Co-worker / Advisor), In annual plan (point at the planning-tool subgoal, e.g. "Yes - 1.2", "Partly - 4.3", or "New item"), Strategic importance for IPPF EN (H/M/L), Effort for me (H/M/L), Status (Active / Dormant / Closed), Recurrence, Delegation potential (H/M/L), Energy (Gives / Neutral / Drains), Funding / project, Notes. When a new topic first appears, the skill may prefill the judgement columns as grounded proposals, saying so in Notes; Ane's later edits are never overwritten. Purpose: year-end work-habit analysis - high Effort + low Importance rows are delegate-or-drop candidates; In-annual-plan vs New-item shows how much of the agenda was planned work; Energy against Times discussed shows what the recurring load actually costs.
