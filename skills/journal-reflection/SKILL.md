...
description: 'Guide Ane through structured reflection at end of day, end of week, after a decision, or after new learning material, producing Obsidian-compatible markdown and writing to the vault journal when the path is reachable. Use on ''journal'', ''reflect on today'', ''weekly review'', ''after-action review'', or asks that reference writing to the Obsidian vault. For a quick 4-line post-deliverable capture use /learned instead.'
---
